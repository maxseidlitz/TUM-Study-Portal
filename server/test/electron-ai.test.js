...
test('Electron Ollama and Gemini reject manipulated writes without explicit latest-user intent', async (t) => {
  ...
  const rejectedMessages = [
    ...
    [{ role: 'user', content: 'Please create a task is what the tutorial button says.' }],
    [{ role: 'user', content: '"Please create a task" is an example.' }],
    [{ role: 'user', content: 'Please create a task appears on the button.' }],
