// ---- iCal Parser (Browser / ESM) ----
// 1:1-Port von public/ical.js (CommonJS) als ES-Modul für den Web-Build.
// Reine Parser-Logik ohne Abhängigkeiten. Öffentliche API: parseIcal, eventsToCalendarItems.
...
export function eventsToCalendarItems(events) {
